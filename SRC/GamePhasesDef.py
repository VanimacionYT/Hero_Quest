...
###############################################################
##                                                           ##
##  File Contains The Necessary Functions For GamePhases.py  ##
##                                                           ##
###############################################################
...
# Random Parameter Function
        #Includes#
        #Player1, Player2, Player1LogSys, Player2LogSys#
def RandomParameters():
    global Player1, Player2, Player1LogSys, Player2LogSys
    retry = 3
...
# Manual Parameter Function
        #Includes#
        #Player1, Player2, Player1LogSys, Player2LogSys#
def ManualParameters():
    global Player1, Player2, Player1LogSys, Player2LogSys
    retry = 3
    for i in range(retry):
        if i != 0:
...
# Parameter Controler Function
        #Includes#
        #ParameterSelection#
def ParameterSelectionDef():
    global ParameterSelection
    os.system('cls' if os.name == 'nt' else 'clear')
...
# Game Turns Controller Function
        #Includes#
        #GameTurns#
def GameTurnsSelection():
    global GameTurns
    retry = 3
    for i in range(retry):
        if i != 0:
...
# Final Game Controler Function
def GamePlay(Parameters, GameTurns):
